package com.hyf.hive.preprocess;
...
import com.hyf.hive.util.AnalysisNginxTool;
import com.hyf.hive.util.DateToNUM;

public class AccessLogPreProcess
{
	public static class AccessLogPreProcessMapper extends Mapper<Object, Text, Text, NullWritable>
	{
	...
	public static class AccessLogPreProcessReducer extends Reducer<Text, NullWritable, Text, NullWritable>
	{
	...
	public static void main(String[] args) throws Exception
	{
		...
		String[] otherArgs = { "hdfs://master:9000/data/access.log", "hdfs://master:9000/uvout/hive" };
